...
class Client extends RPCClient {
  ...
  // Optional fields:
  /**
   * @param {Long} OwnerId - ownerId.
   * @param {String} ResourceOwnerAccount - resourceOwnerAccount.
   * @param {Long} ResourceOwnerId - resourceOwnerId.
   * @param {String} CoverURL - coverUrl.
   * @param {String} Description - description.
   * @param {Long} FileSize - fileSize.
   * @param {Integer} CateId - cateId.
   * @param {String} Tags - tags.
   * @param {JSON String} UserData - Custom configuration.
   */
  // Required fields:
  /**
   * @param {string} AccessKeyId - app key identifier.
   * @param {string} AccessKeySecret - app key secret.
   * @param {string} RegionId - region ID, e.g. eu-central-1.
   * @param {string} StorageLocation - The storage location.
   * @param {string} FileName - fileName.
   * @param {string} Title - title of the video.
   * @param {string} TemplateGroupId - ID of the transcoding template group.
   */
